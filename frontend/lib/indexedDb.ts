const DB_NAME = 'ARTIDatabase';
const STORE_NAME = 'createdArtworks';
const DB_VERSION = 1;
...
export const saveArtwork = async (artwork: any): Promise<void> => {
...
export const getCreatedArtworks = async (): Promise<any[]> => {
  const db = await initializeDB();
  return new Promise((resolve, reject) => {
